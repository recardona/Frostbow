...
namespace BoltFreezer.PlanTools
{
    ...
    public class Graph<T>
    {
        ...
        public HashSet<Utilities.Tuple<T, T>> edges;
        ...
        {
            nodes = new HashSet<T>();
            edges = new HashSet<Utilities.Tuple<T, T>>();
            DescendantMap = new Dictionary<T, HashSet<T>>();
        }

        public Graph(HashSet<T> _nodes, HashSet<Utilities.Tuple<T, T>> _edges, Dictionary<T, HashSet<T>> _descMap)
        {
            nodes = _nodes;
            edges = _edges;
        ...
        //public void AddEdge(Utilities.Tuple<T,T> edge)
        //{
        ...
        public void Insert(T elm1, T elm2)
        {
            ...
            var newEdge = new Utilities.Tuple<T, T>(elm1, elm2);
        ...
        {
            List<Utilities.Tuple<T, T>> edgeList = edges.ToList();
            var L = new List<T>();
            var S = new Stack<T>();
            S.Push(start);
            ...
            while (S.Count > 0)
            {
                var n = S.Pop();
                L.Add(n);
                List<Utilities.Tuple<T, T>> markedForRemoval = edgeList.ToList();
        ...
        public Object Clone()
        {
            ...
            var newEdges = new HashSet<Utilities.Tuple<T, T>>(edges);
